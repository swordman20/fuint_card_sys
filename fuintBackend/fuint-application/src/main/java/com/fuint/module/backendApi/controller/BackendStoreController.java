...
public class BackendStoreController extends BaseController {
    ...
    public ResponseObject saveHandler(HttpServletRequest request, @RequestBody Map<String, Object> params) throws BusinessCheckException {
        ...
        String storeName = params.get("name") == null ? "" : CommonUtil.replaceXSS(params.get("name").toString());
        ...
        String detailDescription = params.get("detailDescription") == null ? "" : params.get("detailDescription").toString();
        List<String> images = params.get("images") == null ? new ArrayList<>() : (List) params.get("images");
        ...
        if (images.size() > 0) {
            ...
            storeInfo.setImages(imagesJson);
        }
        ...
        if (StringUtil.isNotEmpty(detailDescription)) {
            storeInfo.setDetailDescription(detailDescription);
        }
